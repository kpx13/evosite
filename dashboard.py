    ...
    def init_with_context(self, context):
        ...
        self.children.append(
            modules.ModelList(
                ...
                models=(
                    ...
                    'info.models.ActionItem',
                    'info.models.HelpfulInfoItem',
                    'info.models.QAItem',
                    'info.models.LibraryItem',
                ),
            )
        )
        ...
        self.children.append(
            modules.ModelList(
                title = u'База',
                models=(
                    'catalog.models.Industry',
                    'catalog.models.Region',
                    'catalog.models.Item',
                    'update.models.LoadFromFile',
                ),
            )
        )
        ...
        self.children.append(
            modules.ModelList(
                title = u'Пользователи и Оплата',
                models=(
                    'users.models.CustomUser',
                    'users.models.Payment',
                ),
            )
        )
