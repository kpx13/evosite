...
DATABASES = {
    'default': {
        ...
        'NAME': 'evomailing',   # Or path to database file if using sqlite3.
        'USER': 'evomailing',                      # Not used with sqlite3.
        'PASSWORD': '0zv0B1urNa',                  # Not used with sqlite3.
